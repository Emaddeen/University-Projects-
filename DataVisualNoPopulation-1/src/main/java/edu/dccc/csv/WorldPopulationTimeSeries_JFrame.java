...
public class WorldPopulationTimeSeries_JFrame extends JFrame {
    ...
    private XYDataset createDataset( ) {
        TimeSeries series = new TimeSeries("US Population between 1940-2020");
        ArrayList<PopulationDataModel> populationlist;
        ReadCSVWithScanner readCSVWithScanner = new ReadCSVWithScanner();
        try {
            populationlist = readCSVWithScanner.GetPopulationDataModel("resources/WorldPopulation.csv", true);
            ...
            for (PopulationDataModel dp : populationlist ) {
                try {
                    ...
                    Number value = Double.valueOf(dp.getPopulations());
    ...
    public static void main( final String[ ] args ) {
        final String title = "World population 1950-2020 (Billions)";
