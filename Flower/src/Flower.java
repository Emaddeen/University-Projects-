...
public class Flower {
    ...
    private static void flower(Color[] palette, double x, double y, double
        ...
        StdDraw.filledEllipse(x, y, halfWidth*3, halfHeight*3);
...
//
        Color[] palette = { StdDraw.BLACK, StdDraw.BLUE, StdDraw.CYAN,
                ...
                StdDraw.BLUE.darker(), StdDraw.MAGENTA, StdDraw.ORANGE,
                StdDraw.PINK, StdDraw.RED, StdDraw.GREEN.brighter(), StdDraw.YELLOW,
